...
// # Java Assessment javawarmups.Practice Problems
//
//1. Create a class called javawarmups.Practice with a main method.
...
//12. In your javawarmups.Practice class, create a static method named multiplyAll. It should accept an integer and an ArrayList of integers. It should take the ArrayList argument and multiply all its elements by the value of the integer argument.
